...
<head>
  ...
  <style>
    ...
    .modal video { width:80%; height:auto; max-height:80%; }
...
async function searchMovies(query) {
  ...
  try {
    const url = \`https://archive.org/advancedsearch.php?q=\${encodeURIComponent(query)}+collection:(movies)&fl[]=identifier,title&rows=20&page=1&output=json\`;
